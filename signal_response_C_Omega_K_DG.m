...
%             for t_i=1:1:duration
                [x_t(t_i+1)]=baghdadi_DGRRO_map_func(x_t(t_i),A(a_value),Kcoef(a_value),K_dgrro(a_value),sigma,As,Omega,t_i,f_min);
                if t_i>d_trans
...
save(".\Results2\DG\signalResponse\Omega\"+num2str(divide)+"\signal_response_Omega_K_"+num2str(Kcoef(a_value))+"_DG_"+num2str(A(a_value))+".mat");
end
end